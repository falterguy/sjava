...
//		System.out.println(Arrays.toString(a));
		...
		//문자열에서 특정문자나 문자열 포함 여부는 .contains()
		//다음 주소중 선화동에 주소만 추출하여 저장하세요
		//배열에 잘 저장되었는지 확인은 Arrays. 이용하여 출력
		
//		String[] addr = new String[] {
//				"대전 중구 선화동 25", "대전 중구 선화동 92","서전 서구 둔산동 111","대전 서구 둔산동 1023",
//				"대전 유성구 노은동 93", "대전 중구 대흥동 932","대전 동구 가양동 945","대전 중구 선화동 1234","대전 중구 대흥동 23","대전 중구 선화동 984"
//		};
		
	//addr[i].contains("선화동")
	//addr 배열의 크기 만큼 선언하기, 선화동 카운트 수 만큼 선언
