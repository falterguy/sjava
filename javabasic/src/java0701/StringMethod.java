...
//		System.out.println(names[1]);
		...
		System.out.println(word.substring(2,6)	); //6번 전까지
		
		//문자열 변환 
		String 뽀뽀뽀 = "아빠가 출근할때 뽀뽀뽀 엄마가 안아줘도 뽀뽀뽀 만나면 반갑다고 뽀뽀뽀";
		...
		/*
		  	정규표현식 (외우지 않아도 되고 알아두면 좋고 개발자들도 따로 적어놓고 필요할때마다 사용)
		 	^ - 문자열의 시작
		 	$ - 문자열의 종료
		 	. - 임의의 한 문자
